...
All notable changes to Islamic Icons are documented in this file.
...
- **76 logical Islamic icons** across 12 semantic categories
...
- **Catalog** with full metadata: `import { catalog, categories, sources, metadata } from 'islamic-icons'`

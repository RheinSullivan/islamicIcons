...
<p>تصفح جميع الأيقونات الـ 81 في <a href="/ar/icons">معرض الأيقونات</a> أو شاهد <a href="https://github.com/RheinSullivan/islamic-icons">المستودع الكامل</a>.</p>`
	...
	'/docs/sources': {
		...
		lead: 'مرجع عملي للبناء باستخدام آثار المجاهدين مع الحفاظ على الأعمال الفنية محلية وأصولها مرئية.',
		body: `<p>هناك ثلاثة مسارات للمصدر: أصول المجتمع المقدمة لهذا المشروع، والمتجهات المرخصة خارجياً، وGoogle Material Icons. بحث Google للاكتشاف فقط؛ لا يمنح إذن إعادة التوزيع أبداً.</p><h2>الاكتشاف الخارجي</h2><p>يتم مراجعة المرشحين الخارجيين بشكل فردي. تظل صفحة المصدر والترخيص مرفقة بالأصل.</p>${SOURCE_LINKS_HTML}`
	},
	'/docs/donations': {
		title: 'التبرعات والمساعدات الإنسانية',
		lead: 'مرجع عملي للبناء باستخدام آثار المجاهدين مع الحفاظ على الأعمال الفنية محلية وأصولها مرئية.',
		body: `<p>تقبل آثار المجاهدين التبرعات العامة بـ <strong>شفافية مالية 100٪</strong>. يتم تخصيص ما لا يقل عن 70٪ من جميع الأموال للمساعدات الإنسانية، بما في ذلك إغاثة فلسطين والسودان، ودور الأيتام، والأسر ذات الدخل المنخفض، ورعاية المسنين، والإغاثة في حالات الكوارث. يمكن أن تدعم ما يصل إلى 30٪ عمليات البنية التحتية مثل الخادم وCDN وتكاليف النطاق.</p><div class="callout"><b>قناة التبرع</b><span>Buy Me a Coffee: <a href="https://buymeacoffee.com/rheinsullivan" target="_blank" rel="noreferrer">buymeacoffee.com/rheinsullivan ↗</a></span></div><h2>تقارير الشفافية</h2><p>سياسة التقارير العامة المفصلة وفهرس تقرير الشفافية في <strong>docs/en/donations.md</strong>. يجب إضافة البيانات الموثقة لكل فترة تقرير.</p><h2>سياسة التخصيص</h2><p><strong>الحد الأدنى 70٪</strong> مخصص للمساعدات الإنسانية. <strong>حتى 30٪</strong> قد يتم تخصيصها لعمليات الإطار المطلوبة للحفاظ على توفر واستمرارية آثار المجاهدين.</p><div class="framework-list"><article><b>إغاثة فلسطين والسودان</b><code>أولوية المساعدات الإنسانية</code></article><article><b>دور الأيتام</b><code>مساعدات إنسانية</code></article><article><b>الأسر ذات الدخل المنخفض</b><code>مساعدات إنسانية</code></article><article><b>رعاية المسنين</b><code>مساعدات إنسانية</code></article><article><b>الإغاثة في حالات الكوارث</b><code>مساعدات إنسانية</code></article><article><b>الخادم وCDN والنطاق</b><code>عمليات الإطار</code></article></div>`
	},
	'/docs/sources': {
		title: 'المصادر والإسناد',

...
export const docsId: Record<string, DocEntry> = {
	...
	'/docs/usage': {
		title: 'Penggunaan',
		lead: 'Referensi praktis untuk membangun dengan Islamic Icons sambil menjaga karya tetap lokal dan asal-usul tetap terlihat.',
		body: `<p>Gunakan kategori semantik yang berisi ikon yang Anda butuhkan. Contoh framework dan library harus menggunakan bentuk komponen dengan prop <strong>className</strong>, <strong>size</strong>, dan <strong>style</strong>. Contoh Allah di bawah ini adalah sintaks komponen kanonik.</p><h2>Komponen framework / library</h2><pre>&lt;Allah className="" size="" style="" /&gt;</pre><p>Untuk proyek bergaya React, komponen yang sama dapat diimpor dari adaptor framework yang relevan dan dirender langsung di JSX.</p><h2>HTML Native</h2><pre>&lt;atsarul-icon variant="allah" class="" size="" style="" /&gt;</pre><p>HTML native juga dapat mereferensikan SVG lokal secara langsung ketika elemen kustom bukan bagian dari aplikasi.</p><pre>&lt;img src="/assets/icons/mosque/mosque/original.svg" alt="Masjid" /&gt;</pre><p>Semua aset sumber tetap lokal ke package; aplikasi tidak memerlukan permintaan runtime ke API ikon upstream.</p>`
	},
	'/docs/variants': {
		title: 'Varian',
		lead: 'Referensi praktis untuk membangun dengan Islamic Icons sambil menjaga karya tetap lokal dan asal-usul tetap terlihat.',

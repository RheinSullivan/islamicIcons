...
<svelte:head>
	<title>Categories | Islamic Icons</title>
	<meta
		name="description"
		content="Browse Islamic Icons by category and design intent."
	/>
</svelte:head>
...
<main class="{MAX} pt-36 pb-16 sm:pt-44 sm:pb-24 lg:pt-32">
	<div class="gsap-container max-w-3xl">
		...
		>
		<h1 class="mt-3 font-display text-5xl tracking-[-.06em] sm:text-6xl">Categories</h1>
		<p class="mt-5 text-base leading-8 text-islamic-muted">
			Islamic Icons is organized around semantic categories rather than visual style. Each category
			can grow independently as contributors add new artwork.
		</p>
	</div>
